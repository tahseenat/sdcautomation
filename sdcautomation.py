...
def invite():
    try:
        ...
        time.sleep(soft_wait)
        party_xpath = "//*[contains(text(), '{}')]".format("Margarita")
...
def mail2():
    try:
        time.sleep(soft_wait)
        driver.find_element(By.XPATH, "(//*[contains(text(), 'Messenger')])[2]").click()
        time.sleep(long_wait)
        driver.find_element(By.XPATH, '//*[@id="input_message"]').click()
        time.sleep(soft_wait)
        keyboard.write(message)
        time.sleep(soft_wait)
        # click on Add photo
        time.sleep(soft_wait)
        driver.find_element(By.XPATH, """(//*[@class="cursor-pointer" and @role = "presentation"])[2]""").click()
        time.sleep(soft_wait)
        driver.find_element(By.XPATH, """//*[@class="cursor-pointer" and contains(text(),'Photos')]""").click()
        time.sleep(soft_wait)
        ...
        time.sleep(soft_wait)
        driver.find_element(By.XPATH, """(//*[@class="cursor-pointer" and @role = "presentation"])[1]""").click()
        time.sleep(long_wait)
    except:
        pass
...
# enter credentials
username = "masterandmargarita7788@gmail.com"
password = "SDCaccess"
